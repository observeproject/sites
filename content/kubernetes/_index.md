...
- [cluster-total](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/cluster-total.json)
- [controller-manager](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/controller-manager.json)
...
- [k8s-resources-windows-pod](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/k8s-resources-windows-pod.json)
- [k8s-resources-workload](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/k8s-resources-workload.json)
- [k8s-resources-workloads-namespace](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/k8s-resources-workloads-namespace.json)
- [k8s-windows-cluster-rsrc-use](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/k8s-windows-cluster-rsrc-use.json)
- [k8s-windows-node-rsrc-use](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/k8s-windows-node-rsrc-use.json)
- [kubelet](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/kubelet.json)
- [namespace-by-pod](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/namespace-by-pod.json)
- [namespace-by-workload](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/namespace-by-workload.json)
- [persistentvolumesusage](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/persistentvolumesusage.json)
- [pod-total](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/pod-total.json)
- [proxy](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/proxy.json)
- [scheduler](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/scheduler.json)
- [workload-total](https://github.com/observeproject/sites/blob/main/assets/kubernetes/dashboards/workload-total.json)
